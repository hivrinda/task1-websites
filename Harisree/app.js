/* Harisree Home Appliances - app.js */
'use strict';
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  window.addEventListener('scroll', () => {
    navbar.style.boxShadow = window.scrollY > 50 ? '0 4px 24px rgba(234,88,12,0.12)' : '';
  });
  ...
  if (contactForm) {
    contactForm.addEventListener('submit', (e) => {
      ...
      const waText = `Hello Harisree Home Appliances! My name is ${name}. I am interested in: ${product || 'home appliances'}. ${message ? 'Message: ' + message : ''} My phone: ${phone}`;
      ...
      if (entry.isIntersecting) {
        ...
        nums.forEach(n => {
          ...
          if (match) {
            ...
            animateCounter(n, parseInt(match[0]), suffix);
          }
        });
