...
document.addEventListener('DOMContentLoaded', () => {
  ...
  window.addEventListener('scroll', () => {
    navbar.style.boxShadow = window.scrollY > 50 ? '0 4px 24px rgba(124,58,237,0.14)' : '';
  });
  ...
  if (contactForm) {
    contactForm.addEventListener('submit', (e) => {
      ...
      const waText = `Hello Ajwa Home Appliances! My name is ${name}. I am interested in: ${product || 'home appliances'}. ${message ? 'Message: ' + message : ''} My phone: ${phone}`;
      window.open(`https://wa.me/919876012345?text=${encodeURIComponent(waText)}`, '_blank');
